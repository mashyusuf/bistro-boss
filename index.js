   ...
   app.patch('/menu/:id', async (req,res)=>{
    ...
    //---------Delete Time-------
     ...
     app.post('/users', async(req,res)=>{
      ...
      //you can do this many ways----simple way-------
...
app.get('/',(req , res)=>{
    res.send('Boss Is Heree Guys!')
})
app.listen(port,()=>{
    console.log(`Bistro Boss Here Guys Come HERE ${port}`)
})